    ...
    <>
      <div className='relative flex items-center justify-center mt-20 flex-col'>
        ...
        <div className='relative flex flex-col  m-10 gap-10 '>
          ...
          <div className='z-10 flex flex-row items-center md:grid md:grid-cols-3 md:w-full justify-start md:gap-2 w-[380px] min:h-[400px] hide-scrollbar md:px-5 overflow-x-scroll md:mx-0 hide-scrollbar ml-[100px]'>
