  ...
  return (
    <div className="relative md:h-[650px] w-[1400px] left-1/2 transform -translate-x-1/2 flex flex-col items-center justify-center md:my-10 my-20 md:gap-[50px] gap-[25px]">
       <div className="md:absolute top-[26%] left-[15%] z-0 hidden md:block">
        <Image src={vector2} alt="vector 2" width={150} height={150} />
      </div>
      <div className="md:absolute top-[15%] left-[76%] hidden md:block">
        <Image src={vector1} alt="vector 1" width={150} height={150} />
      </div> 
    <div className='md:relative md:z-10 flex md:-space-x-[50px]  flex-wrap items-center justify-center w-[30%] md:w-full md:gap-0 gap-[10px]'>
      ...
      <Image src={crew_1} alt="crew 1" className='md:w-[219px] md:h-auto w-[180.9px] h-auto' />
      <Image src={crew_2} alt="crew 2" className='md:w-[219px] md:h-auto w-[180.9px] h-auto' />
      </div>
      <div className='flex -space-x-[50px]'>
      <Image src={crew_3} alt="crew 3" className='md:w-[219px] md:h-auto w-[180.9px] h-auto' />
      <Image src={crew_4} alt="crew 4" className='md:w-[219px] md:h-auto w-[180.9px] h-auto' />
      </div>
     <div className='flex -space-x-[50px]'>
     <Image src={crew_5} alt="crew 5" className='md:w-[219px] md:h-auto w-[180.9px] h-auto' />
     </div>
    </div>
