...
const TestimonalCard: React.FC<{ testimonalInfo: TestimonalInfo }> = ({ testimonalInfo }) => {
  return (
    <div className="relative flex flex-col items-start justify-between  max-w-[389px] md:h-[528px] h-[346.66px] rounded-[35.39px] shadow-md md:px-10 bg-white md:py-15 p-[30px] md:ml-0 ml-10">
      ...
      <Image src={testimonalInfo.company} width={33} height={33} alt="testimonal_1" className=' h-[21.71px] w-auto'/>
      <div>
