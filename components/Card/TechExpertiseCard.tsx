...
const TechExpertiseCard: React.FC<{ techExpertiseInfo: TechExpertiseInfo; cardType: CardType }> = ({ techExpertiseInfo, cardType }) => {
  ...
  return (
    <div className={`md:h-[229px] md:w-[389px] w-[299px] h-[168px] rounded-[35.39px] shadow-xl px-6 py-3 flex items-center justify-center flex-col gap-2 ${gradientColors} backdrop-blur-xl relative flex-shrink-0`}>
